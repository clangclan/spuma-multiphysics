...
int main(int argc,char** argv){
    ...
    assert(header[0]==0x48454d4341503031ULL&&header[2]==sizeof(ReactiveDeviceFlash::Model));
    ReactiveDeviceFlash::Model model;std::memcpy(&model,bytes.data()+64,sizeof(model));
