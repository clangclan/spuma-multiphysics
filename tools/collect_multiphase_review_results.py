...
CODE=[
    ...
    'src/thermoCheck/thermoCheck.C','src/reactiveFoam/pintleReactiveFoam.C',
...
def run(root,output,paths,pr_log):
    ...
    result=dict(schema_version=1,date='2026-09-11',main_owns_all_code_and_execution=True,
        ...
        current_binaries_sha256={p:b.sha256(root/p) for p in ('bin/spumaPintleColdFoam','bin/pintleReactiveFoam','bin/pintlePrIdentityCheck','lib/libpintleMultiphaseThermo.so','lib/libpintleReactiveBackend.so')},
