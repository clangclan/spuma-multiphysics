...
#ifndef REACTIVE_DEVICE_PR_ALPHA_FACTOR_PROTOTYPE_H
#define REACTIVE_DEVICE_PR_ALPHA_FACTOR_PROTOTYPE_H

#include "reactiveDevicePR.h"

namespace ReactiveDevicePRAlphaFactorPrototype {

template<int NS,int NC,int NR>
REACTIVE_HD inline void chemicalPotentialsRepeated(
...
template<int NS,int NC,int NR>
REACTIVE_HD inline void chemicalPotentialsAlphaCached(
    const ReactiveDevicePR::Table<NC,NR>& table,double T,const double* x,
    double V,double p,double b,double aa,double* mu) {
    using namespace ReactiveDevicePR;
    double factor[NS];
...
REACTIVE_HD inline void chemicalPotentialsFixed4(
    const ReactiveDevicePR::Table<NC,NR>& table,double T,const double* x,
    double V,double p,double b,double aa,double* mu) {
