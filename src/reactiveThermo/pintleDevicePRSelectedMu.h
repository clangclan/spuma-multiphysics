...
#ifndef PINTLE_DEVICE_PR_SELECTED_MU_H
#define PINTLE_DEVICE_PR_SELECTED_MU_H

#include "pintleDevicePR.h"

namespace PintleDevicePRSelectedMu {
...
PINTLE_HD inline bool selected(unsigned mask,int k) {
    return (mask&(1u<<k))!=0;
}
...
PINTLE_HD inline bool omittedMuFiniteCertificate4(
...
template<int NC,int NR>
PINTLE_HD inline Status evaluateTrhoFromMixingCachedSelectedMu4(
