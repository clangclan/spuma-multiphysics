...
#ifndef PINTLE_DEVICE_FLASH_JACOBIAN_H
#define PINTLE_DEVICE_FLASH_JACOBIAN_H

// Analytic active-set UV/chemical-potential Jacobian for pintleDeviceFlash.
...
#ifdef __CUDACC__
#define PINTLE_JAC_CALL __host__ __device__ __noinline__
#else
#define PINTLE_JAC_CALL inline
#endif

namespace PintleDeviceFlashJacobian {

constexpr int MaxSpecies = PintleDevicePR::MaxSpecies;
...
PINTLE_HD inline double subtractProductSeparateRn(double minuend,
...
PINTLE_HD inline bool phasePartials(const PintleDevicePR::Table<NC, NR>& table,
                                    double T, const double* Y,
                                    const PintleDevicePR::State& state,
...
template<int NC, int NR>
PINTLE_HD inline bool gasCompositionPartials(
    const PintleDevicePR::Table<NC, NR>& table, double T,
    const double* x, double totalMoles, const PintleDevicePR::State& state,
...
template<int NC, int NR>
PINTLE_HD inline bool activeGasDerivatives(
    const PintleDevicePR::Table<NC, NR>& table, double T, double p,
...
template<int NC, int NR>
PINTLE_HD inline bool activeGasDerivativesFixed4(
    const PintleDevicePR::Table<NC, NR>& table, double T, double p,
    double molarVolume, const double* Y, double gasMass,
    const int* species, int n,
    ActiveGasDerivatives& output)
...
template<int NC, int NR>
PINTLE_JAC_CALL bool build(
    const PintleDevicePR::Table<NC, NR>* phase, int ns, int nl,
...
template<int NC, int NR>
PINTLE_JAC_CALL bool buildCached(
    const PintleDevicePR::Table<NC, NR>* phase, int ns, int nl,
    const int* condensable, const double* conservedMass,
    const int* active, int n, bool adaptive, const double* partition,
    double p, double T, double scale, double Vp, double VT,
...
template<int NC, int NR>
PINTLE_JAC_CALL bool buildCachedFixed4(
    const PintleDevicePR::Table<NC, NR>* phase, int ns, int nl,
    const int* condensable, const double* conservedMass,
    const int* active, int n, bool adaptive, const double* partition,
    double p, double T, double scale, double Vp, double VT,
