...
#ifndef PINTLE_GPU_HEM_H
#define PINTLE_GPU_HEM_H
#include <stddef.h>
#include <stdint.h>
...
#define PINTLE_GPU_HEM_PHASE_CACHE_BYTES_V1 80u
#ifdef __cplusplus
extern "C" {
#endif
typedef struct {
...
void* pintle_gpu_hem_create_v1(const void* model,size_t modelBytes,size_t capacity,char* error,size_t errorSize);
void pintle_gpu_hem_destroy_v1(void*);
...
int pintle_gpu_hem_run_v1(void*,const double* q,const double* energy,size_t count,
