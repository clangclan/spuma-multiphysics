...
#ifndef REACTIVE_DEVICE_PR_PURE_PHASE_CACHE_PROTOTYPE_H
#define REACTIVE_DEVICE_PR_PURE_PHASE_CACHE_PROTOTYPE_H

#include "reactiveDevicePR.h"

#include <cfloat>

namespace ReactiveDevicePRPurePhaseCachePrototype {
