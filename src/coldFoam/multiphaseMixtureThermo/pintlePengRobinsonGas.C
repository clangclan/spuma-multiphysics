...
Foam::pintlePengRobinsonGas<Specie>::pintlePengRobinsonGas
(
...
template<class Specie>
void Foam::pintlePengRobinsonGas<Specie>::write(Ostream& os) const
{
    Specie::write(os);
}
