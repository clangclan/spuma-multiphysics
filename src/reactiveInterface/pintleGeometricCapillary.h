...
#ifndef PINTLE_GEOMETRIC_CAPILLARY_H
#define PINTLE_GEOMETRIC_CAPILLARY_H
...
#ifdef __CUDACC__
#define PINTLE_GC_HD __host__ __device__
#else
#define PINTLE_GC_HD
#endif

namespace PintleGeometricCapillary {
...
PINTLE_GC_HD inline bool finite(double x) {
...
PINTLE_GC_HD inline bool faceFlux(const State& left,const State& right,
    ...
    PintleBalancedCapillary::State coreLeft{},coreRight{};
    ...
    PintleBalancedCapillary::Face coreFace{};
    for(int d=0;d<3;++d)coreFace.normal[d]=face.normal[d];
    coreFace.sigma=1;
    coreFace.curvature=face.pressureJump;
    PintleBalancedCapillary::Flux core{};
    if(!PintleBalancedCapillary::faceFlux(coreLeft,coreRight,coreFace,core))return false;
