...
#ifndef PINTLE_IMPLICIT_SURFACE_H
#define PINTLE_IMPLICIT_SURFACE_H
...
#ifdef __CUDACC__
#define PINTLE_IS_HD __host__ __device__
#else
#define PINTLE_IS_HD
#endif

namespace PintleImplicitSurface {
...
PINTLE_IS_HD inline bool finite(double x) {
    return x==x&&x<=DBL_MAX&&x>=-DBL_MAX;
}
PINTLE_IS_HD inline double maximum(double a,double b) {return a>b?a:b;}
PINTLE_IS_HD inline double absolute(double x) {return x<0?-x:x;}
PINTLE_IS_HD inline bool validCell(const View& v,const std::int64_t cell[3]) {
...
PINTLE_IS_HD inline std::size_t coefficientIndex(const View& v,
...
PINTLE_IS_HD inline void basis(double u,double b[4],double db[4],double ddb[4]) {
...
PINTLE_IS_HD inline bool evaluateCell(const View& v,const std::int64_t cell[3],
...
PINTLE_IS_HD inline bool linePolynomial(const View& v,const std::int64_t cell[3],
...
PINTLE_IS_HD inline double value(const Cubic& p,double t) {
    return ((p.coefficient[3]*t+p.coefficient[2])*t+p.coefficient[1])*t+p.coefficient[0];
}
PINTLE_IS_HD inline bool addRoot(Roots& roots,double x) {
...
PINTLE_IS_HD inline bool lineRoots(const Cubic& p,Roots& output) {
...
PINTLE_IS_HD inline bool lineRoots(const View& v,const std::int64_t cell[3],
