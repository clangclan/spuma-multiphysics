...
#ifndef PINTLE_BALANCED_CAPILLARY_H
#define PINTLE_BALANCED_CAPILLARY_H

#include <cfloat>
#include <cmath>

#ifdef __CUDACC__
#define PINTLE_BC_HD __host__ __device__
#else
#define PINTLE_BC_HD
#endif

namespace PintleBalancedCapillary {
...
PINTLE_BC_HD inline bool finite(double x) { return x==x && x<=DBL_MAX && x>=-DBL_MAX; }
PINTLE_BC_HD inline double minimum(double a,double b) { return a<b?a:b; }
PINTLE_BC_HD inline double maximum(double a,double b) { return a>b?a:b; }

PINTLE_BC_HD inline bool valid(const State& s) {
...
PINTLE_BC_HD inline bool colorFaceRate(double ownerColor,double neighbourColor,
