...
#ifndef PINTLE_WALE_H
#define PINTLE_WALE_H

#include <cmath>
#include <limits>

#ifdef __CUDACC__
#define PINTLE_WALE_HD __host__ __device__
#else
#define PINTLE_WALE_HD
#endif

namespace PintleWale {
...
PINTLE_WALE_HD inline double absolute(double value)
{
    return value < 0.0 ? -value : value;
}

PINTLE_WALE_HD inline double invalidValue()
{
#ifdef __CUDA_ARCH__
...
PINTLE_WALE_HD inline bool scaledEddyViscosity(
    double coefficient,
    double delta,
    double gradientScale,
    double ratio,
...
PINTLE_WALE_HD inline bool normalizedInvariants(
...
PINTLE_WALE_HD inline bool eddyViscosity(
    const double gradient[9],
    double delta,
    double coefficient,
    double& nut)
...
PINTLE_WALE_HD inline bool filterWidthFromCellVolume(double volume, double& delta)
{
